...
public class PictureInfoModelImpl implements PictureInfoContract.Model{
    private DataInfoBean mDataInfoBean;


    @Override
    public void getPictureInfo(final int page, final GetDataListener getDataListener) {
        //网络请求
        RetrofitManger.getInstance("http://gank.io/api/")
                .getPictureInfo(10, page)
